...
*
*/
	function getOrganizationChartNode (
		node
	){
...
*
*/
	OrganizationChartNode.prototype.setChildCount = function(
		childCount
	){
...
*
*/
	function OrganizationChartNode(label)
	{
...
*	arguments:
*		htmlString: the (html) text to be placed inside the label element. 
*	returns:
*		nothing
*	usage:
*		modify the label text:
*
*		organizationChartNode.setLabelHTML("new name");
*/
	OrganizationChartNode.prototype.setLabelHTML = function(
		html
	){
...
*
*/
	OrganizationChartNode.prototype.setState = function(
		state
	){
...
*
*/			
	OrganizationChartNode.prototype.getChildNode = function(
		position
	){
...
*
*/			
	OrganizationChartNode.prototype.addChildNode = function(
		childOrganizationChartNode
	,	position
	){
		var childrenContainer = this.getChildrenContainer();
...
*
*/
	OrganizationChartNode.prototype.removeChildNode = function(
		position
	){
