...
//    var title = document.getElementsByTagName('title')[0].innerHTML;
    var url = 'http://home.cnblogs.com/wz/create?t=' + encodeURIComponent(document.title) + '&u=' + encodeURIComponent(d.location.href) + '&c=' +
...
function showRemoveLineNumber(element) {
    $(element).append('<div class="cnblogs_code_toolbar"><span class="cnblogs_code_copy"><a href="javascript:void(0);" onclick="removeLineNumber(this)">消除行号</a></span>');
}
