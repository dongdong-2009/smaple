...
function PutInWz() {
    ...
    window.open('http://home.cnblogs.com/wz/create?t=' + encodeURIComponent(d.title) + '&u=' + encodeURIComponent(d.location.href) + '&c=' +
...
$(function () {
    ...
    if (hlCodes.length) {
        ...
        $.each(hlCodes, function () {
            ...
            //if (regexHasLineNumber.test(htmlContent)) {// $.browser.msie || 
