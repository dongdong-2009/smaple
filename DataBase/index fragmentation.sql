--for gathering information of all indexes/heap on specified table
SELECT
...
,func.page_count
FROM
sys.dm_db_index_physical_stats (DB_ID(), OBJECT_ID(N'FoxconnDB'),
...
,func.page_count
FROM
sys.dm_db_index_physical_stats (OBJECT_ID(N'FoxconnDB'), NULL, NULL, NULL, NULL)
AS func
JOIN
sys.indexes AS sysIn
ON
