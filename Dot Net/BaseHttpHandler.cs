...
public abstract class BaseHttpHandler : IHttpHandler
{
    ...
    /// </summary>
    /// <remarks>
    /// <p>This method should result in a call to one (or more) of
    ...
    /// <p><code>someStream.Save(context.Response.OutputStream);</code></p>
    /// <p>etc...</p>
    /// <p>
    /// If you want a download box to show up with a pre-populated
    /// filename, add this call here (supplying a real filename).</p>
    /// <p>
    /// </p><code>Response.AddHeader("Content-Disposition", "attachment; filename=\"" + Filename + "\"");</code>
    /// </p>
    /// </remarks>
    /// <param name="context">Context.</param>
