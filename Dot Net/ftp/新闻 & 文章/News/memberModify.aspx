<%@ Page Language="C#" Inherits="Article.MemberModify" %>
...
<td class="mframe-t-mid">
	<span class="mframe-t-text"><%=lang["title_profile"]%></span>
</td>
...
<td class="mframe-m-mid" style="padding:10px">
	<asp:Label id="myLabel" runat="server" Width="100%" Style="text-align:center"/>
	<asp:PlaceHolder id="phForm" runat=server>
	<table width=95% align=center>
	<tr><td width=250>
		<b><%=lang["member_name"]%></b>
	</td><td>
		<asp:TextBox id="name" ReadOnly="true" MaxLength=50 Size=20 runat="server"/>
	</td></tr>
	<tr><td width=200>
		<b><%=lang["member_password"]%></b>
	</td><td>
		<asp:TextBox TextMode="Password" id="oldpass" MaxLength=50 Size=20 runat="server"/>
	...
	<tr><td width=200>
		...
		<asp:TextBox id="msn" MaxLength=20 Size=20 runat="server"/>
		 <asp:RegularExpressionValidator
	...
	<tr><td width=200>
		...
		<%
		male.Items[0].Text=lang["member_sex_male"].ToString();
		male.Items[1].Text=lang["member_sex_female"].ToString();
		%>
	...
	<tr><td width=200>
		...
		<%=lang["birth_year"]%><asp:RegularExpressionValidator
	...
	<tr><td colspan=2 height=30 align=center>
		<asp:Button id="btPost" Text="ÐÞ¸Ä" Onclick="btPost_Onclick" runat=server/>
	</td></tr>
	</table>
	</asp:PlaceHolder>
