    ...
    public class CompositeNumericUpDown:CompositeControl,IPostBackEventHandler
    {
        ...
        protected override Style CreateControlStyle()
        {
            if (_controlStyle == null)
            {
                ...
                _controlStyle.Height = new Unit(1.2d, UnitType.Em);
                _controlStyle.Width = new Unit(100d);
                _controlStyle.BorderColor = Color.Blue;
                _controlStyle.BorderStyle = BorderStyle.Solid;
                _controlStyle.BorderWidth = new Unit(1d);
                _controlStyle.Position = PositionMode.Relative;
            }
            return _controlStyle;
        }
